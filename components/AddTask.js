        ...
        >
          <div className="group relative transition-all w-full">
            <input
              name="task"
              type="text"
              className="!text-black group !bg-gray-50 border-0 shadow-lg border-gray-300 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
